...
//Double Paragon:
TextStyle perritosDoubleParagon = GoogleFonts.pompiere(
    color: perritosCharcoal, fontSize: 40);

TextStyle perritosDoubleParagonLight = GoogleFonts.pompiere(
    color: perritosSnow, fontSize: 40);
...
TextStyle perritosDoublePicaLight = GoogleFonts.pompiere(
    color: perritosSnow, fontSize: 24);

TextStyle perritosDoublePicaLightOpacity = GoogleFonts.pompiere(
    color: perritosSnow.withOpacity(0.5), fontSize: 24);

//Paragon:
TextStyle perritosParagon = GoogleFonts.pompiere(
...
TextStyle perritosParagonMaizeCrayola = GoogleFonts.pompiere(
    color: perritosMaizeCrayola, fontSize: 20
);

//English:
TextStyle perritosEnglish = GoogleFonts.pompiere(
